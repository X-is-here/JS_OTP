...
autoCompleteInputTag.addEventListener("keyup", (event) => {
  ...
  if(hasProductsToShow) {
    for(let i = 0; i < filteredProducts.length; i++){
      ...
      productIteamContainer.append(productName, productImage);
...
const navigateAndSelectProduct = (key) => {
 ...
 const selectProduct = (index) => {
  ...
  const productIteamContainerToselect = document.getElementById( productIdToSelect );

  productIteamContainerToselect.style.backgroundColor = "#237BFF";
  productIteamContainerToselect.firstChild.style.color = "white";
